...
animationScripts.push({
  ...
  function() {
    ...
    box.position.z = lerp(-15, 2, scalePercent(animationScripts[0].start, animationScripts[0].end))
    torus.position.z = lerp(10, -20, scalePercent(animationScripts[0].start, animationScripts[0].end))
  }
})
